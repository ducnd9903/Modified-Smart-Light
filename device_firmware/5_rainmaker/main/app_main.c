...
#define APP_FIRMWARE_VERSION "2.1.9"
...
void app_main()
{
    ...
    //new ota version
    esp_rmaker_node_add_fw_version(node, APP_FIRMWARE_VERSION);
...
//update OTA version 1
    while (1) 
    {
    ESP_LOGI(TAG, "[%02d] Hello world! Firmware Version: 1.0.1", i++);
    vTaskDelay(pdMS_TO_TICKS(5000));
    }
}